...
/**
 * @see https://github.com/anonyco/FastestSmallestTextEncoderDecoder/blob/master/individual/FastestTextEncoderPolyfill.src.js
 */
module.exports = function polyfillTextEncoder(window) {
  'use strict'
  var log = Math.log
  var LN2 = Math.LN2
  var clz32 =
  ...
  TextEncoderPrototype['encode'] = function (inputString) {
    ...
    var encodedString =
      inputString === void 0
        ? ''
        : ('' + inputString).replace(/[\x80-\uD7ff\uDC00-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]?/g, encoderReplacer)
