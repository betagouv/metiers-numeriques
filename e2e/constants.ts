...
export const TEST_JOBS = [
  {
    ...
    contractTypes: [JOB_CONTRACT_TYPE_LABEL.CONTRACT_WORKER, JOB_CONTRACT_TYPE_LABEL.FREELANCER],
  ...
  },
  {
    ...
    applicationContacts: [TEST_CONTACTS[0], TEST_CONTACTS[1]],
    contractTypes: [JOB_CONTRACT_TYPE_LABEL.NATIONAL_CIVIL_SERVANT, JOB_CONTRACT_TYPE_LABEL.PART_TIME],
    infoContact: TEST_CONTACTS[2],
  ...
  },
  {
    ...
    applicationContacts: [TEST_CONTACTS[0], TEST_CONTACTS[1]],
    contractTypes: [JOB_CONTRACT_TYPE_LABEL.PERMANENT, JOB_CONTRACT_TYPE_LABEL.TEMPORARY],
    infoContact: TEST_CONTACTS[3],
