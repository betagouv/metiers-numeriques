...
export default function generateMinistryFromNotionMinistry(notionMinistry: NotionMinistry) {
  try {
    ...
    return new Ministry({
      ...
      project: convertNotionNodeToHtml(notionMinistry.properties['Les projets ou rélisations']),
      ...
      testimonial: convertNotionNodeToHtml(notionMinistry.properties['Nos agents en parlent']),
      testimonialFiles: convertNotionNodeToHtmls(notionMinistry.properties['Liens Nos agents en parlent']),
      thumbnailUrl: convertNotionNodeToString(notionMinistry.properties['Vignette temporaire']),
      title,
      value: convertNotionNodeToHtml(notionMinistry.properties.Valeurs),
